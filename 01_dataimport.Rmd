...
pw2015_demographie_select = pw2015_demographie %>%
  select(session, short_session, ended, sex, age, occupation, education, sex_orientation, attracted_to,
         starts_with("NARQ_"), starts_with("BFI_K"))


pw2015_items_select = pw2015_items %>%
  select(session, short_session, ended,
...
pw2015_t2_ende_select = pw2015_t2_ende %>%
  select(session, short_session, ended, notes_to_us_t2)
```
...
pw2015_t3_start_select = pw2015_t3_start %>%
  select(session, short_session, ended, F_self_t3_life_events,F_self_t3_life_event_other)


pw2015_t3_singles_select = pw2015_t3_singles %>%
  select(session, short_session, ended, F_self_t3_interest_longterm_single_now)


pw2015_t3_relationship_number_select = pw2015_t3_relationship_number %>%
  select(session, short_session, ended, F_t3_relationship_ultimate, F_t3_relationship)


pw2015_t3_partners_select = pw2015_t3_partners %>%
  select(session, short_session, ended, F_t3_start, F_t3_lasting, F_t3_end, F_t3_breakup, F_t3_kind,
         F_t3_past_kind, F_t3_closeup_kind)
...
pw2015_t3_ende_select = pw2015_t3_ende %>%
  select(session, short_session, ended, F_t3_honesty_check, F_t3_dishonest_answers, F_t3_notes_to_us)
```
